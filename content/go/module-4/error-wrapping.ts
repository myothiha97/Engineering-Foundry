          ...
          diagram: {
            ...
            nodes: [
              ...
              { id: "unwrap", label: "Unwrap()", detail: "peel one layer inward" },
              {
                id: "found",
                label: "match / end",
                detail: "true if equal, else stop at nil",
                tone: "success",
              },
            ],
            caption:
      ...
      blocks: [
        {
          ...
          diagram: {
            ...
            nodes: [
              {
                id: "s1",
                label: "store: return ErrNotFound",
                detail: '"not found"',
                tone: "danger",
              },
              {
